...
pub type GetOneDatabaseUserData = DatabaseUser;
...
impl Endpoint for GetOneDatabaseUser {
    type Data = GetOneDatabaseUserData;
    type Error = Error;
